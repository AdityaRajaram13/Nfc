...
//       <button className="mt-2" onClick={toggleNavbar}>{isOpen ? <X /> : <Menu />}</button>
//     </div>
//       </div>
...
//       <img
//       src={profileimage} // Adjust the path to your image
//       alt="Profile"
//       className="h-12 w-12 mb-2 rounded-full cursor-pointer border-4 border-blue-400 p-2 glow-pink"
...
//   )}
// {showDropdown && (
//   <div className="md:hidden w-full sticky top-0 bg-pink-400 shadow rounded-md mt-2" ref={dropdownRef}>
...
// </div>
//       <Link to="/" className="text-lg mb-2 text-white bg-gradient-to-r from-pink-500 via-pink-600 to-pink-700 hover:from-pink-800 hover:via-pink-900 hover:to-pink-900 p-2 rounded-full">Home</Link>
//       <div className="md:hidden basic-full flex flex-col items-center w-full">
//         <button
//           className="md:hidden text-lg mb-2 text-white bg-gradient-to-r from-pink-500 via-pink-600 to-pink-700 hover:from-pink-800 hover:via-pink-900 hover:to-pink-900 p-2 rounded-full"
...
//         {showProductDropdown && (
//           <div
//             className="md:hidden justify-center sticky flex-wrap w-full bg-pink-400 shadow rounded-md mt-2"
//             ref={dropdownRef}
//           >
//             <ul className="py-2 px-4 space-y-2">
//               <li
